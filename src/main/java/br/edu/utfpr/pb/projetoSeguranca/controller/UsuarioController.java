...
import br.edu.utfpr.pb.projetoSeguranca.service.PermissaoService;
...
public class UsuarioController extends CrudController<Usuario, Long>{
    ...
    @PostMapping("ajax")
    public ResponseEntity<?> saveAjax(@Valid Usuario entity, BindingResult result, RedirectAttributes attributes){
        if(result.hasErrors()){
